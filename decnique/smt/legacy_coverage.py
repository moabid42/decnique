"""LEGACY z3 string-theory coverage — kept only for the differential test against
:mod:`decnique.smt.coverage` (see docs/COVERAGE_ABSTRACTION.md).  Do not use in new code.

Original docstring: Symbolic single-event coverage — ``Reach ∧ Log ∧ ¬⋁Observes`` (plan §M2).
